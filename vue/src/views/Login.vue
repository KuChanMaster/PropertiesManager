<template>
  <div class="container">
    ...
    <div style="width: 400px; padding: 30px; background-color: #f8ecdb; border-radius: 5px;">
      <div style="text-align: center; font-size: 20px; margin-bottom: 20px; color: #333">欢迎使用小区物业管理系统</div>
